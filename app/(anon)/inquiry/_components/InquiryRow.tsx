  ...
  return (
    ...
    >
      ...
      <td className="py-4 px-2 text-center relative">
        ...
        {isModalOpen && (
          <span className="block text-left cursor-default">
            <div
              onClick={(e) => {
                e.stopPropagation();
                setIsModalOpen(false);
            ...
            >
              <div
                ...
                className="bg-white p-6 rounded-sm shadow-lg w-full max-w-sm border border-gray-200 cursor-default"
              >
                ...
                >
                  <input
                    ...
                    className="w-full border border-gray-300 p-2 text-sm outline-none focus:border-gray-900 rounded-sm text-black"
                    autoFocus
                  />
                  <div className="flex gap-2 justify-end text-sm font-medium mt-2">
                    ...
                    <button
                      type="submit"
                      className="px-4 py-2 bg-[#222] text-white rounded-sm hover:bg-[#111]/90 transition-colors"
                    >
                      확인
                    </button>
                  </div>
