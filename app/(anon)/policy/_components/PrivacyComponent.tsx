  ...
  return (
    <main className="px-1 sm:px-0">
      <header className="flex items-center gap-3 mb-6 sm:mb-8">
        <div>
          <h1 className="text-lg sm:text-xl font-semibold mb-1.5 sm:mb-2 text-green-600">
            개인정보 처리방침
          </h1>
      ...
      <section className="mt-6 sm:mt-8">
        <h2 className="text-base sm:text-lg font-semibold text-green-600 flex items-center gap-2">
        ...
        <ul className="mt-2 space-y-1.5 text-xs sm:text-sm text-gray-700 list-disc list-inside">
      ...
      <section className="mt-6 sm:mt-8">
        <div className="rounded-md border border-gray-100 bg-gray-50 px-3.5 sm:px-4 py-2.5 sm:py-3 text-xs sm:text-sm text-gray-700 leading-relaxed">
          <p>
          ...
          <div className="mt-2 space-y-1">
            ...
            <p>
              · 비밀번호:{" "}
              <span className="font-mono text-[11px] sm:text-xs">test1234</span>
            </p>
            <p>
      ...
      <section className="mt-6 sm:mt-8">
        ...
        <ul className="mt-2 sm:mt-3 space-y-1.5 text-xs sm:text-sm text-gray-700 list-disc list-inside">
          <li>
      ...
      <section className="mt-6 sm:mt-8 mb-4">
        <h2 className="text-base sm:text-lg font-semibold text-green-600 flex items-center gap-2">
          <span className="w-1.5 h-1.5 rounded-full bg-green-600" />
          제8조 (처리방침 변경)
        </h2>
      ...
      <section className="mt-6 sm:mt-8">
        <div className="flex items-start gap-2.5 sm:gap-3 rounded-lg border border-green-100 bg-green-50 px-3.5 sm:px-4 py-2.5 sm:py-3">
          <Info className="w-4 h-4 sm:w-5 sm:h-5 text-green-600 mt-0.5 shrink-0" />
