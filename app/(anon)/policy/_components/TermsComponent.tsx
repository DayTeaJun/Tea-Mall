  ...
  return (
    <main className="px-1 sm:px-0">
      ...
      <section className="mt-6 sm:mt-8">
        ...
        <ul className="mt-2 sm:mt-3 space-y-1.5 text-xs sm:text-sm text-gray-700 leading-relaxed list-disc list-inside">
          <li>
            본 사이트는{" "}
      ...
      <section className="mt-6 sm:mt-8">
        ...
        <ul className="mt-2 space-y-1.5 text-xs sm:text-sm text-gray-700 leading-relaxed list-disc list-inside">
